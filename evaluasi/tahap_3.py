...
for idx_b, row_b in tower_b_df.iterrows():
    ...
    # Condition 1: Total distance limit
    meets_dist_limit = min_total_dist <= 6.0

    # Condition 2: Does B->A cross backbone?
    ...
    if meets_dist_limit and not crosses_backbone:
        ...
        # Connect B to Backbone directly (already calculated in Tower B step)
        final_connections_b.append({
            'tower_b_index': row_b['tower_index'],
            'connect_to': 'Backbone',
            'target_index': None,
...
# Plot Tower A and their connections to BB
...
# Plot Tower B and their new connections
